...
class book_main : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        item123.add(Book("qweqweqwe", "Что такое Ёга?", "Предлагаем вниманию читателя научно-популярный труд Йога Рамачараки, посвященный учению индийских йогов. Эта книга для тех кто ищет реальное Знание о реальном Мире. Рамачарака отвечает на самые сложные вопросы реинакрнации и развития Души.", "title"))
